...
<img width="671" height="220" alt="image" src="https://github.com/user-attachments/assets/a2e64a14-7f24-4a9d-9463-6abdc9349081" />
...
<img width="495" height="236" alt="image" src="https://github.com/user-attachments/assets/f279d942-8184-4b93-b8c7-60975dbc2a33" />
...
<img width="348" height="137" alt="image" src="https://github.com/user-attachments/assets/1d743949-4b2e-4910-a321-6abe8d0e31a4" />
...
Respuesta: A mi consideracion, el mas facil de comprender es Python debido a su facilidad para entenderlo, ademas que no requiere conocimientos profundos para su entendimiento ademas que no difiere mucho de otros lenguajes como por ejemplo, Java.
...
```
A continuacion se muestra una aplicacion practica de la funcion getAverage en scala:
```scala
var nums = List(10, 20, 30)
var nums: List[Int] = List(10, 20, 30)

//resultado:
getAverage(nums)
val res0: Double = 20.0
```
...
scala-cli repl
```
Los codigos generados por ChatGPT son los siguientes:
...
```scala
def getAverage(nums: List[Int]): Double =
  if nums.nonEmpty then nums.sum.toDouble / nums.size
  else 0.0
